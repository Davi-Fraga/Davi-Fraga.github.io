        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {skillCategories.map((category) => {
            ...
            return (
              <div
                key={category.id}
                className="group flex h-full flex-col justify-between rounded-xl border border-border/80 bg-card p-6 transition-all duration-200 hover:border-primary/40 hover:shadow-sm"
              >
